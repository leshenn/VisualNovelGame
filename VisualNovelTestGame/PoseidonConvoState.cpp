...
PoseidonConvoState::PoseidonConvoState(sf::Vector2u windowSize) : windowSize(windowSize) {}

void PoseidonConvoState::load() {
    // Load main character
    ...
    // Load background
    backgroundTexture.loadFromFile("Backgrounds/PoseidonBackground.jpg");
    ...
    // Load Poseidon
    godTexture.loadFromFile("Characters/Poseidon.png");
    ...
    dialogText.setString("I am Poseidon, God of the Seas.");
    dialogText.setCharacterSize(24);
    dialogText.setFillColor(sf::Color::Black);
    dialogText.setPosition(300, 375);
}

void PoseidonConvoState::update() {
    // Handle updates (if needed)
}

void PoseidonConvoState::draw(sf::RenderWindow& window) {
