...
void loadGameAssets(GameState currentState, LoadSprites& loadSprites, DialogManager& dialog)
{
    ...
    case GameState::ATLANTIS_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/StageOne/AtlantisCity.png", "Characters/Kourouna.png", "Acessories/Scroll.png");
        break;

    case GameState::SHRINE_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/StageOne/ShrineHallways.png", "Characters/Leucothea.png", "Acessories/Scroll.png");
        break;

    case GameState::HADES_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/HadesBackground.jpg", "Characters/Cerberus.png", "Acessories/Scroll.png");
        break;

    case GameState::DIONYSUS_CHOICE:
        loadSprites.loadGameScreen("Backgrounds/StageOne/Dionysus/Lake.png", "Characters/Dionysus.png", "Acessories/Scroll.png");
        break;

    case GameState::KOMOS_SCENE:
        loadSprites.loadGameScreen("Backgrounds/StageOne/Lake.png", "Characters/Komos.png", "Acessories/Scroll.png");
        break;

    case GameState::FOREST_SCENE:
        loadSprites.loadGameScreen("Backgrounds/StageOne/Forest.png", "Characters/Nymph.png", "Acessories/Scroll.png");
        break;


    case GameState::STAGE_TWO_MENU:
        loadSprites.loadMenuScreen("Backgrounds/StageOne/Athens.png");
        break;

    case GameState::APOLLO_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/StageTwo/Apollo/Stage.png", "Characters/Lyrix.png", "Acessories/Scroll.png");
        break;

    case GameState::HEPHAESTUS_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/StageTwo/Hephaestus/Forge.png", "Characters/Pyra.png", "Acessories/Scroll.png");
        break;

    case GameState::ATHENA_QUIZ:
        loadSprites.loadGameScreen("Backgrounds/StageTwo/Athena/Study.png", "Characters/Cecrops.png", "Acessories/Scroll.png");
        break;
...
void handleGameLogic(RenderWindow& window, GameState& currentState, ButtonLayout& layout, LoadSprites& loadSprites, Event& event, Audio& audio, QuizUI& quiz, DialogManager& dialog, ProgressBar& progressBar, JsonManager& jm)
{
    ...
    case GameState::DIONYSUS_CHOICE:
        if (event.type == Event::MouseButtonPressed) {
            ...
            if (newState != GameState::NONE) {
                currentState = newState; // Should be KOMOS_SCENE or FOREST_SCENE
            }
        }
        loadGameAssets(currentState, loadSprites, dialog);
        renderGameScene(window, currentState, layout, loadSprites, quiz, dialog, audio, progressBar);
    ...
    case GameState::SHRINE_QUIZ:
        ...
        if (event.type == Event::MouseButtonPressed) {
            if (!quiz.isQuizComplete()) {
                ...
                if (currentScore > 5 && currentState == GameState::ATLANTIS_QUIZ) {
                    currentState = GameState::ATLANTIS_WIN_SCENE;
                }
                else if(currentScore <= 5 && currentState == GameState::ATLANTIS_QUIZ) {
                    currentState = GameState::ATLANTIS_LOSE_SCENE;  //TESTING STATES
                }
                else if (currentScore > 5 && currentState == GameState::SHRINE_QUIZ) {
                    currentState = GameState::SHRINE_WIN_SCENE;
                }
                else if (currentScore <= 5 && currentState == GameState::SHRINE_QUIZ) {
                    currentState = GameState::SHRINE_LOSE_SCENE;
                }
    ...
    case GameState::HEPHAESTUS_QUIZ:
        ...
        if (event.type == Event::MouseButtonPressed) {
            if (!quiz.isQuizComplete()) {
                ...
                int currentScore = quiz.getScore();
                if (currentScore > 7) {
                    currentState = GameState::HEPHAESTUS_PRIVATE_FORGE_SCENE;
                }
                else {
                    currentState = GameState::HEPHAESTUS_WAITING_SCENE;  //TESTING STATES
                }
            }
        }
   ...
   */
    ...
    case GameState::POSEIDON_END_SCENE:
        updateGameState(window, currentState, layout, loadSprites, event, audio, quiz, dialog, progressBar, jm, "Jsons/StageOne/Poseidon/POSEIDON_END_SCENE.json", GameState::ATHENS_SCENE);
        break;
    ...
    case GameState::ATHENS_SCENE:
        updateGameState(window, currentState, layout, loadSprites, event, audio, quiz, dialog, progressBar, jm, "Jsons/StageOne/Athens.json", GameState::STAGE_TWO_MENU);
        break;
