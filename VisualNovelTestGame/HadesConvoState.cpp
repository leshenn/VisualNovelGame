...
HadesConvoState::HadesConvoState(sf::Vector2u windowSize) : windowSize(windowSize) {}

void HadesConvoState::load() {
    // Load main character
    ...
    // Load background
    backgroundTexture.loadFromFile("Backgrounds/HadesBackground.jpg");
    ...
    // Load Hades
    godTexture.loadFromFile("Characters/Hades.png");
    ...
    dialogText.setString("I am Hades, God of the Underworld.");
    dialogText.setCharacterSize(24);
    dialogText.setFillColor(sf::Color::Black);
    dialogText.setPosition(300, 375);
}

void HadesConvoState::update() {
    // Handle updates (if needed)
}

void HadesConvoState::draw(sf::RenderWindow& window) {
